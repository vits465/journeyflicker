...
I am viewing this destination on your website and would like a customized quotation!`;
  ...
  return (
    <div className="overflow-x-hidden w-full">
      <SEO 
        title={`${destination.name} | JourneyFlicker`} 
        description={destination.description || destination.essenceText} 
      ...
      <section className="pt-24 md:pt-28 pb-8 px-4 sm:px-8 md:px-16 max-w-5xl mx-auto animate-reveal-up">
        <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
          <nav className="flex flex-wrap items-center text-[9px] tracking-[0.3em] uppercase text-on-surface-variant font-bold">
            ...
            <span className="cursor-pointer hover:text-black dark:hover:text-white transition-colors" onClick={() => navigate('/destinations')}>Territories</span>
            <span className="mx-3 text-outline-variant/30">/</span>
